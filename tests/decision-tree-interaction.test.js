...
test('valid decision path renders a result', () => {
  ...
  app.handleAnswer('Jah, normaalne', 'p-always-related', 'root');
  app.handleAnswer('Jah', 'pr-interval', 'p-always-related');
  app.handleAnswer('Normaalne', 'result-sinus', 'pr-interval');
...
test('stale option from a previous question is ignored', () => {
  const app = loadApp();
